...
const Services = () => {
  return (
    <div className="relative">
      <div className="h-auto relative mb-[40px] max-w-[1440px] mx-auto w-full">
        <h1 className="md:text-[32px] text-[#161616] font-poppins font-[700] text-[24px] text-center pt-[30px] md:pt-[40px] ">
          Our Online Legal <br className="md:hidden" />
          Assistance <span className="text-[#0023FF]">Services</span>
        </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2  w-full ">
            <div className="xl:mt-[10px]">
              ...
              <p className="font-poppins font-[400] text-[14px] lg:text-[16px] xl:text-[20px] md:text-[20px] text-[#161616]  lg:max-w-[300px] xl:max-w-[500px] mt-[10px]">
                Don’t want to spend hundreds of pounds on legal advice? Get
                legal guidance on employment law from qualified lawyers. Our
                employment legal experts are available 24 hours a day for your
                assistance.
              </p>
            </div>
            ...
            <div className="mt-4 lg:grid  lg:place-items-end lg:w-full">
              <div className="">
                ...
                <p className="font-poppins font-[400] text-[14px] md:text-[20px] lg:text-[16px] xl:text-[20px] lg:max-w-[300px]  text-[#161616] xl:max-w-[400px]">
                  ...
                  our criminal defense lawyers who specialise in defending
                  against criminal charges and legal proceedings.
                </p>
              </div>
            </div>
            ...
            <div className="mt-4 lg:mt-[20px] xl:mt-[70px]">
              ...
              <p className="font-poppins font-[400] text-[14px] lg:text-[16px] md:text-[20px] xl:text-[20px] text-[#161616] lg:max-w-[300px]  xl:max-w-[400px]">
                If you need an immigration lawyer, UK based, then our
                immigration lawyers can help you with visa applications,
                residency permits, citizenship, and other immigration matters.
              </p>
            </div>
            ...
            <div className=" mt-[20px] xl:mt-[70px]  grid  place-items-end w-full">
              <div className="">
                ...
                <p className="font-poppins font-[400] lg:text-[16px] xl:text-[20px] text-[14px] md:text-[20px] text-[#161616] lg:max-w-[300px] xl:max-w-[400px]">
                  Receive business legal support on contract drafting,
                  commercial disputes, intellectual property rights, company
                  formation, and other business legal issues from our business
                  Law experts.
                </p>
              </div>
            </div>
