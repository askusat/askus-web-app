...
export default function ContactForm() {
  ...
  return (
      <div className="text-black  max-w-[600px] w-full md:h-[600px] sm:h-auto mb-4 border-t-primary border-t-[8px]  bg-white border-2 rounded-lg shadow-xl pt-10 px-8">
          ...
          <div className="md:flex  sm:space-y-4 md:space-x-0 md:space-y-0  justify-center sm:flex-col md:flex-row  items-center gap-3 ">
          ...
          <div className="mt-4 flex flex-col">
              ...
              <Textarea label="Description"
                  ...
                  variant="bordered"
                    className="w-full h-[150px]" onChange={(e: any) => setHelp(e.target.value)} />
          </div>
